...
async function createABRTemplates() {
    ...
    for (const [resolution, ladder] of Object.entries(abrLadders)) {
        ...
        await createTemplate(mediaconvertClient, qvbrTemplateName, resolution, ladder, false);
        ...
        if (enableMediaPackage) {
            ...
            await createTemplate(mediaconvertClient, mvodTemplateName, resolution, ladder, true);
...
// Run the script
createABRTemplates().catch(console.error);
