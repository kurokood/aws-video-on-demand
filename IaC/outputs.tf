...
output "mediaconvert_templates" {
  ...
  value = {
    ...
    all_templates = module.media_resources.template_names
  }
}
...
output "workflow_monitoring" {
  ...
  value = {
    ...
    media_resources        = "MediaConvert templates and MediaPackage configuration created via PowerShell scripts"
  }
}